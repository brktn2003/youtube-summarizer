      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm font-medium text-gray-600 dark:text-gray-400">
            ...
            <a href="#summarize" className="transition-colors hover:text-indigo-600 dark:hover:text-indigo-400">
              Summarize
            </a>
            <a href="#pricing" className="transition-colors hover:text-indigo-600 dark:hover:text-indigo-400">
              Pricing
            </a>
          </nav>
        ...
        <div className="mt-8 border-t border-gray-100 pt-8 dark:border-gray-800/50">
          <p className="text-center text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {currentYear} YouTube Summarizer. Summaries are generated with Google Gemini; transcripts come from YouTube captions.
          </p>
        </div>
      </div>
    </footer>
